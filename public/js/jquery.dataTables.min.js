...
(function(l) {
    ...
    function Mb(a) {
        ...
        b = l("<div/>", { id: h.f ? null : c + "_filter", "class": b.sFilter }).append(l("<label/>").attr("class", "w-100").append(g));
        var k = function(n) {
    ...
    function Ra(a, b, c) {
        ...
        0 === h || -1 === e ? d = 0 : "number" === typeof b ? (d = b *
            e, d > h && (d = 0)) : "first" == b ? d = 0 : "previous" == b ? (d = 0 <= e ? d - e : 0, 0 > d && (d = 0)) : "next" == b ? d + e < h && (d += e) : "last" == b ? d = Math.floor((h - 1) / e) * e : da(a, 0, "Unknown paging action: " + b, 5);
    ...
    u.defaults = {
        ...
        oLanguage: {
            ...
            oPaginate: { sFirst: "الأول", sLast: "الاخير", sNext: "التالي", sPrevious: "السابق" },
    ...
    l.extend(u.ext.classes, {
        ...
        sFilter: "dataTables_filter w-100",
