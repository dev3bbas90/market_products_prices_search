...
var $jscomp = $jscomp || {};
$jscomp.scope = {};
$jscomp.findInternal = function(l, y, A) { l instanceof String && (l = String(l)); for (var q = l.length, E = 0; E < q; E++) { var P = l[E]; if (y.call(A, P, E, l)) return { i: E, v: P } } return { i: -1, v: void 0 } };
$jscomp.ASSUME_ES5 = !1;
...
$jscomp.getGlobal = function(l) { l = ["object" == typeof globalThis && globalThis, l, "object" == typeof window && window, "object" == typeof self && self, "object" == typeof global && global]; for (var y = 0; y < l.length; ++y) { var A = l[y]; if (A && A.Math == Math) return A } throw Error("Cannot find global object"); };
...
$jscomp.polyfill = function(l, y, A, q) { y && ($jscomp.ISOLATE_POLYFILLS ? $jscomp.polyfillIsolated(l, y, A, q) : $jscomp.polyfillUnisolated(l, y, A, q)) };
$jscomp.polyfillUnisolated = function(l, y, A, q) {
    ...
    q = A[l];
    y = y(q);
    y != q && null != y && $jscomp.defineProperty(A, l, { configurable: !0, writable: !0, value: y })
};
$jscomp.polyfillIsolated = function(l, y, A, q) {
    ...
    y = y(A);
    null != y && (l ? $jscomp.defineProperty($jscomp.polyfills, E, { configurable: !0, writable: !0, value: y }) : y !== A && ($jscomp.propertyToPolyfillSymbol[E] = $jscomp.IS_SYMBOL_NATIVE ? $jscomp.global.Symbol(E) : $jscomp.POLYFILL_PREFIX + E,
...
(function(l) {
    "function" === typeof define && define.amd ? define(["jquery"], function(y) { return l(y, window, document) }) : "object" === typeof exports ? module.exports = function(y, A) {
        y || (y = window);
    ...
    function ma(a) {
        ...
        if (a) {
            ...
            !a.sEmptyTable && d && "لا يوجد منتجات في البحث" === b.sEmptyTable && X(a, a, "sZeroRecords", "sEmptyTable");
            !a.sLoadingRecords && d && "Loading..." === b.sLoadingRecords &&
                X(a, a, "sZeroRecords", "sLoadingRecords");
            a.sInfoThousands && (a.sThousands = a.sInfoThousands);
            (a = a.sDecimal) && c !== a && Za(a)
        }
    }
    ...
    function Ga(a, b, c) {
        ...
        c !== q && null !== c && (Cb(c), P(u.defaults.column, c, !0), c.mDataProp === q || c.mData || (c.mData = c.mDataProp), c.sType && (b._sManualType = c.sType), c.className && !c.sClass && (c.sClass = c.className), c.sClass && e.addClass(c.sClass), h = b.sClass, l.extend(b, c), X(b, c, "sWidth", "sWidthOrig"), h !== b.sClass && (b.sClass = h + " " + b.sClass), c.iDataSort !== q && (b.aDataSort = [c.iDataSort]),
            X(b, c, "aDataSort"));
        var f = b.mData,
            g = na(f),
    ...
    function ta(a, b) { a = Ia(a, "bVisible"); return "number" === typeof a[b] ? a[b] : null }
    ...
    function Ja(a, b) {
        ...
        return b.map(function(d, e) { c = db(a, e); return ia(a, c.data, e, c.cells) })
    }
    ...
    function T(a, b, c, d) {
        ...
        if (k === q) return a.iDrawError != e && null === g && (da(a, 0, "Requested unknown parameter " + ("function" == typeof h.mData ? "{function}" : "'" + h.mData + "'") + " for row " + b + ", column " + c, 4), a.iDrawError =
            e), g;
    ...
    function Gb(a, b, c, d) { a.aoColumns[c].fnSetData(a.aoData[b]._aData, d, { settings: a, row: b, col: c }) }

    function eb(a) { return l.map(a.match(/(\\.|[^\.])+/g) || [""], function(b) { return b.replace(/\\\./g, ".") }) }

    function fb(a) { return U(a.aoData, "_aData") }
    ...
    function va(a, b, c, d) {
        ...
        } else e._aData = db(a, e, d, d === q ? q : e._aData).data;
        e._aSortData = null;
        e._aFilterData = null;
        f =
            a.aoColumns;
    ...
    function gb(a, b) {
        ...
        if (c) {
            ...
            d.DT_RowClass && (a = d.DT_RowClass.split(" "),
                b.__rowc = b.__rowc ? Ma(b.__rowc.concat(a)) : a, l(c).removeClass(b.__rowc.join(" ")).addClass(d.DT_RowClass));
    ...
    function ja(a, b) {
        ...
        if (-1 !== l.inArray(!1, c)) V(a, !1);
            ...
            else if (!a.bDestroying && !b) { Ib(a); return }
            if (0 !== k.length)
            ...
            F(a, "aoFooterCallback", "footer", [l(a.nTFoot).children("tr")[0], fb(a), m, n, k]);
            d = l(a.nTBody);
            d.children().detach();
            d.append(l(c));
    ...
    function Kb(a) {
        ...
        var d = a.oFeatures,
            e = l("<div/>", { id: a.sTableId + "_wrapper", "class": b.sWrapper + " row " + (a.nTFoot ? "" : " " + b.sNoFooter) });
        a.nHolding = c[0];
        a.nTableWrapper = e[0];
        ...
        for (var h = a.sDom.split(""), f, g, k, m, n, p, t = 0; t < h.length; t++) {
            ...
            else if ("l" == g && d.bPaginate && d.bLengthChange) f = Lb(a);
            else if ("f" == g && d.bFilter) f = Mb(a);
            else if ("r" == g && d.bProcessing) f = Nb(a);
            else if ("t" == g) f = Ob(a);
            else if ("i" == g && d.bInfo) f = Pb(a);
            else if ("p" == g && d.bPaginate) f = Qb(a);
    ...
    function za(a, b, c) {
        ...
        if (!c) return "data" === a ? b.aaData || b[a] : "" !== a ? na(a)(b) :
            b;
        ha(a)(b, c)
    }
    ...
    function Mb(a) {
        ...
        b = l("<div/>", { id: h.f ? null : c + "_filter", "class": b.sFilter }).append(l("<label/>").attr("class", "w-75").append(g));
        var k = function(n) {
            var p = this.value ? this.value : "";
            e.return && "Enter" !== n.key || p == e.sSearch || (ya(a, { sSearch: p, bRegex: e.bRegex, bSmart: e.bSmart, bCaseInsensitive: e.bCaseInsensitive, "return": e.return }),
                a._iDisplayStart = 0, ja(a))
        };
        h = null !== a.searchDelay ? a.searchDelay : "ssp" === Q(a) ? 400 : 0;
        var m = l("input", b).val(e.sSearch).attr("placeholder", d.sSearchPlaceholder).on("keyup.DT search.DT input.DT paste.DT cut.DT", h ? jb(k, h) : k).on("mouseup", function(n) { setTimeout(function() { k.call(m[0], n) }, 10) }).on("keypress.DT", function(n) { if (13 == n.keyCode) return !1 }).attr("aria-controls", c).attr("class", " form-control");
    ...
    function ya(a,
        ...
        bb(a);
        if ("ssp" != Q(a)) {
            Tb(a, b.sSearch, c, f(b), b.bSmart, b.bCaseInsensitive, b.return);
            h(b);
            for (b = 0; b < e.length; b++) Ub(a, e[b].sSearch, b, f(e[b]), e[b].bSmart, e[b].bCaseInsensitive);
            Vb(a)
        } else h(b);
        a.bFiltered = !0;
        F(a, null, "search", [a])
        ...
        for (c = a.aoData.length; h <
            ...
            if (!f._aFilterData) {
                ...
                for (d = b.length; e < d; e++) {
                    ...
                    k.indexOf && -1 !== k.indexOf("&") && (Qa.innerHTML = k, k = Ac ? Qa.textContent : Qa.innerText);
    ...
    function Yb(a) { return { sSearch: a.search, bSmart: a.smart, bRegex: a.regex, bCaseInsensitive: a.caseInsensitive } }

    function Pb(a) {
        var b = a.sTableId,
            c = a.aanFeatures.i,
            d = l("<div/>", { "class": a.oClasses.sInfo, id: c ? null : b + "_info" });
        c || (a.aoDrawCallback.push({ fn: Zb, sName: "information" }), d.attr("role", "status").attr("aria-live", "polite"), l(a.nTable).attr("aria-describedby", b + "_info"));
        return d[0]
    }
        ...
        h.p || (b.id = a.sTableId + "_paginate", a.aoDrawCallback.push({
            fn: function(f) {
                if (d) {
                    ...
                    var p;
                    n = 0;
                    for (p = h.p.length; n < p; n++) ib(f, "pageButton")(f, h.p[n], n, m, g, k)
                } else c.fnUpdate(f, e)
            },
            sName: "pagination"
        }));
    ...
    function Ra(a, b, c) {
        ...
        0 === h || -1 === e ? d = 0 : "number" === typeof b ? (d = b *
            e, d > h && (d = 0)) : "الاول" == b ? d = 0 : "السابق" == b ? (d = 0 <= e ? d - e : 0, 0 > d && (d = 0)) : "next" == b ? d + e < h && (d += e) : "الاخر" == b ? d = Math.floor((h - 1) / e) * e : da(a, 0, "Unknown paging action: " + b, 5);
    ...
    function Nb(a) { return l("<div/>", { id: a.aanFeatures.r ? null : a.sTableId + "_processing", "class": a.oClasses.sProcessing }).html(a.oLanguage.sProcessing).append("<div><div></div><div></div><div></div><div></div></div>").insertBefore(a.nTable)[0] }
    ...
    function Ob(a) {
        ...
        }).append(l("<div/>", { "class": h.sScrollHeadInner }).css({ "box-sizing": "content-box", width: c.sXInner || "100%" }).append(k.removeAttr("id").css("margin-left", 0).append("top" === g ? f : null).append(b.children("thead"))))).append(l("<div/>", { "class": h.sScrollBody }).css({ position: "relative", overflow: "auto", width: d ? K(d) : null }).append(b));
        n && k.append(l("<div/>", { "class": h.sScrollFoot }).css({ overflow: "hidden", border: 0, width: d ? d ? K(d) : null : "100%" }).append(l("<div/>", { "class": h.sScrollFootInner }).append(m.removeAttr("id").css("margin-left",
    ...
    function Ha(a) {
        ...
        if (a.scrollBarVis !== fa && a.scrollBarVis !== q) a.scrollBarVis = fa, sa(a);
            ...
            var ob = x.clone().prependTo(w);
            x = x.find("tr");
            fa = ob.find("tr");
            ob.find("th, td").removeAttr("tabindex");
            c || (p.width = "100%", h[0].style.width = "100%");
            l.each(Na(a, ob), function(D, W) {
                Y = ta(a, D);
                W.style.width = a.aoColumns[Y].sWidth
            });
            G && ca(function(D) { D.style.width = "" }, ba);
            h = w.outerWidth();
            "" === c ? (C.width = "100%", L && (w.find("tbody").height() > g.offsetHeight || "scroll" == n.css("overflow-y")) &&
                (C.width = K(w.outerWidth() - b)), h = w.outerWidth()) : "" !== d && (C.width = K(d), h = w.outerWidth());
            ca(Ba, fa);
            ca(function(D) {
            ...
            Math.round(w.outerWidth()) < Math.round(h) ? (la = g.scrollHeight > g.offsetHeight || "scroll" == n.css("overflow-y") ? h + b : h, L && (g.scrollHeight > g.offsetHeight || "scroll" == n.css("overflow-y")) && (C.width = K(la - b)), "" !== c && "" === d || da(a, 1, "Possible column misalignment", 6)) :
                la = "100%";
            p.width = K(la);
            f.width = K(la);
    ...
    function ab(a) {
        ...
        if (d || !t && !h && !e && g == oa(a) && g == m.length)
            ...
            for (v = 0; v < k.length; v++) w = c[k[v]], m[v].style.width = null !== w.sWidthOrig &&
                "" !== w.sWidthOrig ? K(w.sWidthOrig) : "", w.sWidthOrig && h && l(m[v]).append(l("<div/>").css({ width: w.sWidthOrig, margin: 0, padding: 0, border: 0, height: 1 }));
            if (a.aoData.length)
                for (v = 0; v < k.length; v++) t = k[v], w = c[t], l(bc(a, t)).clone(!1).append(w.sContentPadding).appendTo(r);
            ...
            h && f ? g.width(f) : h ? (g.css("width", "auto"), g.removeAttr("width"), g.width() < p.clientWidth && n &&
                g.width(p.clientWidth)) : e ? g.width(p.clientWidth) : n && g.width(n);
        ...
        n && (b.style.width = K(n));
        !n && !h || a._reszEvt || (b = function() { l(y).on("resize.DT-" + a.sInstance, jb(function() { sa(a) })) }, d ? setTimeout(b, 1E3) : b(), a._reszEvt = !0)
    }
    ...
    function bc(a, b) { var c = cc(a, b); if (0 > c) return null; var d = a.aoData[c]; return d.nTr ? d.anCells[b] : l("<td/>").html(T(a, c, b, "display"))[0] }

    function cc(a, b) { for (var c, d = -1, e = -1, h = 0, f = a.aoData.length; h < f; h++) c = T(a, h, b, "display") + "", c = c.replace(Bc, ""), c = c.replace(/&nbsp;/g, " "), c.length > d && (d = c.length, e = h); return e }
    ...
    function ec(a) {
        ...
        for (var d = 0, e = b.length; d < e; d++) {
            ...
            h.bSortable && (0 < c.length && c[0].col == d ? (k.setAttribute("aria-sort", "asc" == c[0].dir ? "ascending" : "descending"), h = f[c[0].index + 1] || f[0]) :
                h = f[0], g += "asc" === h ? a.sSortAscending : a.sSortDescending);
    ...
    function pb(a, b, c, d) {
        ...
        c && a.oFeatures.bSortMulti ? (c = l.inArray(b, U(e, "0")), -1 !== c ? (b = f(e[c], !0), null === b && 1 === e.length && (b = 0), null === b ? e.splice(c, 1) : (e[c][1] = h[b], e[c]._idx = b)) : (e.push([b, h[0], 0]), e[e.length - 1]._idx = 0)) : e.length && e[0][0] ==
            b ? (b = f(e[0]), e.length = 1, e[0][1] = h[b], e[0]._idx = b) : (e.length = 0, e.push([b, h[0]]), e[0]._idx = 0);
        ka(a);
    ...
    function hb(a, b, c, d) {
        var e = a.aoColumns[c];
        qb(b, {}, function(h) {!1 !== e.bSortable && (a.oFeatures.bProcessing ? (V(a, !0), setTimeout(function() { pb(a, c, h.shiftKey, d); "ssp" !== Q(a) && V(a, !1) }, 0)) : pb(a, c, h.shiftKey, d)) })
    }
    ...
    function Ca(a) {
        if (!a._bLoadingState) {
            var b = {
                ...
                columns: l.map(a.aoColumns, function(c, d) { return { visible: c.bVisible, search: Xb(a.aoPreSearchCols[d]) } })
            };
            a.oSavedState = b;
    ...
    function fc(a, b, c) {
        if (a.oFeatures.bStateSave) return b = a.fnStateLoadCallback.call(a.oInstance, a, function(d) { rb(a, d, c) }), b !== q && rb(a, b, c), !0;
        c()
    }
    ...
    function rb(a, b, c) {
        ...
        if (b && b.time) {
            ...
            if (-1 !== l.inArray(!1, f)) a._bLoadingState = !1;
                ...
                b.start !== q && (null === h ? (a._iDisplayStart = b.start, a.iInitDisplayStart =
                    b.start) : Ra(a, b.start / a._iDisplayLength));
                b.order !== q && (a.aaSorting = [], l.each(b.order, function(k, m) { a.aaSorting.push(m[0] >= e.length ? [0, m[1]] : m) }));
                b.search !== q && l.extend(a.oPreviousSearch, Yb(b.search));
                if (b.columns) {
                    f = 0;
                    for (d = b.columns.length; f < d; f++) {
                        var g = b.columns[f];
                        g.visible !== q && (h ? h.column(f).visible(g.visible, !1) : e[f].bVisible = g.visible);
                        g.search !== q && l.extend(a.aoPreSearchCols[f], Yb(g.search))
                    }
                    h && h.columns.adjust()
                }
                a._bLoadingState = !1;
    ...
    function ib(a, b) {
        ...
        return l.isPlainObject(a) && a[b] ? c[a[b]] || c._ : "string" === typeof a ? c[a] ||
            c._ : c._
    }
    ...
    function Za(a) {
        l.each({
            num: function(b) { return Ua(b, a) },
            "num-fmt": function(b) { return Ua(b, a, tb) },
            "html-num": function(b) { return Ua(b, a, Va) },
    ...
    function hc(a, b, c, d, e) { return y.moment ? a[b](e) : y.luxon ? a[c](e) : d ? a[d](e) : a }

    function Wa(a, b, c) {
        if (y.moment) { var d = y.moment.utc(a, b, c, !0); if (!d.isValid()) return null } else if (y.luxon) {
            d = b ? y.luxon.DateTime.fromFormat(a, b) : y.luxon.DateTime.fromISO(a);
            if (!d.isValid) return null;
            d.setLocale(c)
        } else b ? (ic || alert("DataTables warning: Formatted date without Moment.js or Luxon - https://datatables.net/tn/17"),
            ic = !0) : d = new Date(a);
        return d
    }
    ...
    function ub(a) {
        return function(b, c, d, e) {
            ...
            var h = "datetime-" + c;
            u.ext.type.order[h] || (u.ext.type.detect.unshift(function(f) { return f === h ? h : !1 }), u.ext.type.order[h + "-asc"] = function(f, g) {
                f = f.valueOf();
                g = g.valueOf();
            ...
            return function(f, g) {
                if (null ===
                    f || f === q) "--now" === e ? (f = new Date, f = new Date(Date.UTC(f.getFullYear(), f.getMonth(), f.getDate(), f.getHours(), f.getMinutes(), f.getSeconds()))) : f = "";
                if ("type" === g) return h;
                if ("" === f) return "sort" !== g ? "" : Wa("0000-01-01 00:00:00", null, d);
                if (null !== c && b === c && "sort" !== g && "type" !== g && !(f instanceof Date)) return f;
                var k = Wa(f, b, d);
                if (null === k) return f;
                if ("sort" === g) return k;
                f = null === c ? hc(k, "toDate", "toJSDate", "")[a]() : hc(k, "format", "toFormat", "toISOString", c);
                return "display" === g ? Xa(f) : f
            }
        }
    }
    ...
    var u = function(a, b) {
            ...
            for (var h in u.ext.internal) h && (this[h] = jc(h));
            this.each(function() {
                var f = {},
                    g = 1 < e ? sb(f, b, !0) : b,
                    k = 0,
                ...
                if ("table" != this.nodeName.toLowerCase()) da(null, 0, "Non-table node initialisation (" + this.nodeName + ")", 2);
                    ...
                    k = 0;
                    for (m = v.length; k < m; k++) $a(r, f ? f[k] : null);
                    Fb(r, g.aoColumnDefs, v, function(I, H) { Ga(r, I, H) });
                    if (aa.length) {
                    ...
                    R(r, "aoDrawCallback",
                        Ca, "state_save");
                    g.bStateSave ? (O.bStateSave = !0, fc(r, g, f)) : f()
                }
            });
            c = null;
            return this
        ...
        lc = function(a) { var b = parseInt(a, 10); return !isNaN(b) && isFinite(a) ? b : null },
        mc = function(a, b) {
        ...
        nc = function(a, b, c) { return Z(a) ? !0 : Z(a) || "string" === typeof a ? wb(a.replace(Va, ""), b, c) ? !0 : null : null },
        U = function(a, b, c) {
            var d = [],
                e = 0,
                h = a.length;
        ...
        oc = function(a) { for (var b = [], c = 0, d = a.length; c < d; c++) a[c] && b.push(a[c]); return b },
        Ma = function(a) {
            a: {
                if (!(2 > a.length)) {
                    var b = a.slice().sort();
        ...
        pc = function(a, b) {
            if (Array.isArray(b))
                for (var c = 0; c < b.length; c++) pc(a, b[c]);
            else a.push(b);
            return a
        },
        qc = function(a, b) { b === q && (b = 0); return -1 !== this.indexOf(a, b) };
    Array.isArray || (Array.isArray = function(a) { return "[object Array]" === Object.prototype.toString.call(a) });
    Array.prototype.includes || (Array.prototype.includes = qc);
    String.prototype.trim || (String.prototype.trim = function() {
        return this.replace(/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g,
            "")
    });
    String.prototype.includes || (String.prototype.includes = qc);
    u.util = {
        ...
        set: function(a) {
            ...
            if ("string" !== typeof a || -1 ===
                a.indexOf(".") && -1 === a.indexOf("[") && -1 === a.indexOf("(")) return function(c, d) { c[a] = d };
        ...
        get: function(a) {
            ...
            if ("string" !== typeof a || -1 === a.indexOf(".") && -1 === a.indexOf("[") &&
                -1 === a.indexOf("(")) return function(d, e) { return d[a] };
    ...
    var S = function(a, b, c) { a[b] !== q && (a[c] = a[b]) },
        ...
        Ec = function(a) {
            ...
            if (a) {
                ...
                if (a.nodeName && "table" === a.nodeName.toLowerCase()) { var e = l.inArray(a, d); return -1 !== e ? [c[e]] : null }
    ...
    l.extend(B.prototype, {
        ...
        pluck: function(a) { var b = u.util.get(a); return this.map(function(c) { return b(c) }) },
        pop: N.pop,
        push: N.push,
        reduce: N.reduce || function(a, b) { return Eb(this, a, b, 0, this.length, 1) },
        reduceRight: N.reduceRight || function(a, b) { return Eb(this, a, b, this.length - 1, -1, -1) },
        reverse: N.reverse,
        selector: null,
        shift: N.shift,
    ...
    var sc = function(a, b) { if (Array.isArray(a)) return l.map(a, function(d) { return sc(d, b) }); if ("number" === typeof a) return [b[a]]; var c = l.map(b, function(d, e) { return d.nTable }); return l(c).filter(a).map(function(d) { d = l.inArray(this, c); return b[d] }).toArray() };
    z("tables()", function(a) { return a !== q && null !== a ? new B(sc(a, this.context)) : this });
    z("table()", function(a) {
        a = this.tables(a);
        var b = a.context;
        return b.length ?
    ...
    z("draw()", function(a) { return this.iterator("table", function(b) { "page" === a ? ja(b) : ("string" === typeof a && (a = "full-hold" === a ? !1 : !0), ka(b, !1 === a)) }) });
    z("page()", function(a) { return a === q ? this.page.info().page : this.iterator("table", function(b) { Ra(b, a) }) });
    ...
    z("page.len()", function(a) { return a === q ? 0 !== this.context.length ? this.context[0]._iDisplayLength : q : this.iterator("table", function(b) { mb(b, a) }) });
    ...
    z("ajax.json()", function() { var a = this.context; if (0 < a.length) return a[0].json });
    z("ajax.params()", function() { var a = this.context; if (0 < a.length) return a[0].oAjaxData });
    z("ajax.reload()", function(a, b) { return this.iterator("table", function(c) { tc(c, !1 === b, a) }) });
    ...
    z("ajax.url().load()", function(a, b) { return this.iterator("table", function(c) { tc(c, !1 === b, a) }) });
    var xb = function(a, b, c, d, e) {
            ...
            if (a.length)
                for (m =
                    0, g = a.length; m < g; m++) h = a[m](d, e, h);
            return Ma(h)
        },
        yb = function(a) {
            a || (a = {});
        ...
        Fc = function(a, b, c) {
            ...
            return xb("row", b,
                function(e) {
                    ...
                    if ("string" === typeof e &&
                        "#" === e.charAt(0) && (h = a.aIds[e.replace(/^#/, "")], h !== q)) return [h.idx];
                    h = oc(Ea(a.aoData, d, "nTr"));
    ...
    z("rows()", function(a, b) {
        ...
        b = yb(b);
        var c = this.iterator("table", function(d) { return Fc(d, a, b) }, 1);
        c.selector.rows = a;
        c.selector.opts = b;
        return c
    });
    z("rows().nodes()", function() { return this.iterator("row", function(a, b) { return a.aoData[b].nTr || q }, 1) });
    z("rows().data()", function() {
        return this.iterator(!0,
            "rows",
            function(a, b) { return Ea(a.aoData, b, "_aData") }, 1)
    });
    ...
    z("row().node()", function() { var a = this.context; return a.length && this.length ? a[0].aoData[this[0]].nTr || null : null });
    ...
    l(A).on("plugin-init.dt", function(a, b) {
        ...
        c && c.childRows && a.rows(l.map(c.childRows, function(d) { return d.replace(/:/g, "\\:") })).every(function() { F(b, null, "requestChild", [this]) })
    });
    var Gc = function(a, b, c, d) {
        ...
        uc = u.util.throttle(function(a) { Ca(a[0]) }, 500),
        Ab = function(a, b) {
            var c = a.context;
        ...
        vc = function(a, b) {
            ...
            if (c.length && a.length) {
                ...
                d._details && ((d._detailsShow = b) ? (d._details.insertAfter(d.nTr), l(d.nTr).addClass("dt-hasChild")) : (d._details.detach(), l(d.nTr).removeClass("dt-hasChild")), F(c[0], null, "childRow", [b, a.row(a[0])]), Hc(c[0]), uc(c))
            }
        },
        Hc = function(a) {
            var b = new B(a),
            ...
            0 < U(c, "_details").length && (b.on("draw.dt.DT_details",
                ...
                if (a === e)
                    for (d = 0, e = c.length; d < e; d++) c[d]._details && Ab(b, d)
            }))
        };
    z("row().child()", function(a, b) {
        ...
        if (a === q) return c.length && this.length ? c[0].aoData[this[0]]._details :
            q;
        !0 === a ? this.child.show() : !1 === a ? Ab(this) : c.length && this.length && Gc(c[0], c[0].aoData[this[0]], a, b);
        return this
    });
    z(["row().child.show()", "row().child().show()"], function(a) { vc(this, !0); return this });
    z(["row().child.hide()", "row().child().hide()"], function() { vc(this, !1); return this });
    z(["row().child.remove()", "row().child().remove()"], function() { Ab(this); return this });
    z("row().child.isShown()", function() { var a = this.context; return a.length && this.length ? a[0].aoData[this[0]]._detailsShow || !1 : !1 });
    var Ic =
        /^([^:]+):(name|visIdx|visible)$/,
        ...
        Jc = function(a, b, c) {
            var d = a.aoColumns,
                e = U(d, "sName"),
                h = U(d, "nTh");
            return xb("column", b, function(f) {
                var g = lc(f);
                if ("" === f) return qa(d.length);
                if (null !== g) return [0 <= g ? g : d.length + g];
                if ("function" === typeof f) { var k = Ya(a, c); return l.map(d, function(p, t) { return f(t, wc(a, t, 0, 0, k), h[t]) ? t : null }) }
                var m = "string" === typeof f ? f.match(Ic) : "";
                if (m) switch (m[2]) {
                    case "visIdx":
                    case "visible":
                        g = parseInt(m[1],
    ...
    z("columns()", function(a, b) {
        a === q ? a = "" : l.isPlainObject(a) && (b = a,
            a = "");
        b = yb(b);
        var c = this.iterator("table", function(d) { return Jc(d, a, b) }, 1);
        c.selector.cols = a;
        c.selector.opts = b;
        return c
    });
    ...
    J("columns().data()", "column().data()", function() { return this.iterator("column-rows", wc, 1) });
    J("columns().dataSrc()",
        "column().dataSrc()",
    ...
    z("columns.adjust()", function() { return this.iterator("table", function(a) { sa(a) }, 1) });
    z("column.index()", function(a, b) { if (0 !== this.context.length) { var c = this.context[0]; if ("fromVisible" === a || "toData" === a) return ta(c, b); if ("fromData" === a || "toVisible" === a) return ua(c, b) } });
    z("column()", function(a, b) { return zb(this.columns(a, b)) });
    ...
    z("cells()", function(a, b, c) {
        ...
        if (null === b || b === q) return this.iterator("table", function(n) { return Kc(n, a, yb(c)) });
    ...
    z("order.listener()", function(a, b, c) { return this.iterator("table", function(d) { hb(d, a, b, c) }) });
    ...
    z("search()", function(a, b, c, d) { var e = this.context; return a === q ? 0 !== e.length ? e[0].oPreviousSearch.sSearch : q : this.iterator("table", function(h) { h.oFeatures.bFilter && ya(h, l.extend({}, h.oPreviousSearch, { sSearch: a + "", bRegex: null === b ? !1 : b, bSmart: null === c ? !0 : c, bCaseInsensitive: null === d ? !0 : d }), 1) }) });
    ...
    z("state()", function() { return this.context.length ? this.context[0].oSavedState : null });
    z("state.clear()", function() { return this.iterator("table", function(a) { a.fnStateSaveCallback.call(a.oInstance, a, {}) }) });
    z("state.loaded()", function() { return this.context.length ? this.context[0].oLoadedState : null });
    ...
    z("clear()", function() { return this.iterator("table", function(a) { Ka(a) }) });
    z("settings()", function() { return new B(this.context, this.context) });
    z("init()", function() { var a = this.context; return a.length ? a[0].oInit : null });
    z("data()", function() { return this.iterator("table", function(a) { return U(a.aoData, "_aData") }).flatten() });
    z("destroy()", function(a) {
        ...
        return this.iterator("table", function(b) {
            ...
            var k = l(b.nTableWrapper),
                m = l.map(b.aoData, function(p) { return p.nTr }),
                n;
            b.bDestroying = !0;
            ...
            l("th, td", h).removeClass(c.sSortable + " " + c.sSortableAsc +
                " " + c.sSortableDesc + " " + c.sSortableNone);
            e.children().detach();
            e.append(m);
            ...
            g[f]();
            k[f]();
            !a && h && (h.insertBefore(d, b.nTableReinsertBefore), g.css("width", b.sDestroyWidth).removeClass(c.sTable), (n = b.asDestroyStripes.length) && e.children().each(function(p) { l(this).addClass(b.asDestroyStripes[p % n]) }));
    ...
    u.defaults = {
        ...
        oLanguage: {
            ...
            oPaginate: { sFirst: "الأول", sLast: "الاخير", sNext: "next", sPrevious: "السابق" },
            sEmptyTable: "لا يوجد منتجات في البحث",
            sInfo: "عرض _START_ الي _END_ من _TOTAL_ منتجات",
            sInfoEmpty: "عرض 0 الي 0 من 0 منتجات",
            sInfoFiltered: "(filtered from _MAX_ total entries)",
            sInfoPostFix: "",
            sDecimal: "",
            sThousands: ",",
            sLengthMenu: "عرض _MENU_ منتجات",
            sLoadingRecords: "Loading...",
            sProcessing: "",
            sSearch: "",
            sSearchPlaceholder: "إبحث هنا",
    ...
    l.extend(u.ext.classes, {
        ...
        sFilter: "dataTables_filter col-9",
        sInfo: "dataTables_info",
        sPaging: "dataTables_paginate paging_",
        sLength: "dataTables_length col-3",
    ...
    l.extend(u.ext.type.detect, [function(a, b) { b = b.oLanguage.sDecimal; return wb(a, b) ? "num" + b : null }, function(a, b) {
        if (a && !(a instanceof Date) && !Cc.test(a)) return null;
        b = Date.parse(a);
        return null !== b && !isNaN(b) || Z(a) ? "date" : null
    }, function(a,
        b) { b = b.oLanguage.sDecimal; return wb(a, b, !0) ? "num-fmt" + b : null }, function(a, b) { b = b.oLanguage.sDecimal; return nc(a, b) ? "html-num" + b : null }, function(a, b) { b = b.oLanguage.sDecimal; return nc(a, b, !0) ? "html-num-fmt" + b : null }, function(a, b) { return Z(a) || "string" === typeof a && -1 !== a.indexOf("<") ? "html" : null }]);
    l.extend(u.ext.type.search, { html: function(a) { return Z(a) ? a : "string" === typeof a ? a.replace(kc, " ").replace(Va, "") : "" }, string: function(a) { return Z(a) ? a : "string" === typeof a ? a.replace(kc, " ") : a } });
    var Ua = function(a,
        b, c, d) {
    ...
    var Xa = function(a) { Array.isArray(a) && (a = a.join(",")); return "string" === typeof a ? a.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/"/g, "&quot;") : a },
        ic = !1,
        xc =
        "",
        yc = "";
    if (Intl) {
        var zc = (new Intl.NumberFormat).formatToParts(1000.1);
        xc = zc[1].value;
        yc = zc[3].value
    }
    u.datetime = function(a, b) {
        ...
        b || (b = "en");
        u.ext.type.order[c] || (u.ext.type.detect.unshift(function(d) { var e = Wa(d, a, b); return "" === d || e ? c : !1 }), u.ext.type.order[c + "-pre"] = function(d) { return Wa(d, a, b) || 0 })
    };
    u.render = {
        date: ub("toLocaleDateString"),
        datetime: ub("toLocaleString"),
        time: ub("toLocaleTimeString"),
    ...
    l.extend(u.ext.internal, {
        ...
        _fnCalculateColumnWidths: ab,
        _fnThrottle: jb,
        _fnConvertToWidth: ac,
        _fnGetWidestNode: bc,
        _fnGetMaxLenString: cc,
        _fnStringToCss: K,
        _fnSortFlatten: pa,
        _fnSort: Jb,
        _fnSortAria: ec,
        _fnSortListener: pb,
        _fnSortAttachListener: hb,
        _fnSortingClasses: Sa,
        _fnSortData: dc,
        _fnSaveState: Ca,
        _fnLoadState: fc,
        _fnImplementState: rb,
